...
spisok_doc = os.listdir('H:\Pythonprojects\\textsegment1\\venv\original_docs')
...
with col1:
  with st.container():
    ...
    filename1 = 'H:\Pythonprojects\\textsegment1\\venv\original_docs\\'+spisok_doc[counter2]
...
with col3:
  with st.container():
    ...
    filename2 = 'H:\Pythonprojects\\textsegment1\\venv\modified_docs\\'+spisok_doc[counter2]
