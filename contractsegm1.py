...
st.write('Обучение нейронной сети проводилось на старой базе типовых договоров, поэтому точность может отличаться от действительной. Для улучшения точности нужна новая база с правильной разметкой.')
